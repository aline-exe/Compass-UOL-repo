...
# rand paises end
df_nomes.withColumnRenamed("_c0", "Nomes")  # renomear coluna
df_nomes = df_nomes.withColumn(
...
df_millenials = spark.sql(
    "SELECT * FROM pessoas WHERE AnoNascimento >= 1980 AND AnoNascimento <= 1994"
)

millenials = df_millenials.count()
